...
const Login: NextPage = () => {
  ...
  return (
    <main className="max-w-md p-8 mx-auto mb-8 space-y-3  flex flex-col items-center justify-center px-4 mt-20 border rounded-xl ">
      <div className="max-w-sm w-full text-gray-600 space-y-8">
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <input
              type="email"
              required
              className="w-full mt-2 border-gray-300 rounded-lg shadow-sm text-gray focus:border-gray-500 focus:ring-gray-500"
              // className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
            />
          </div>
          <button className="w-full mt-4 px-4 py-2 text-white font-medium bg-red-500 hover:bg-red-600 active:bg-red-300 rounded-lg duration-150">
            Sign in
          </button>
        </form>
        ...
        <div className="space-y-4 text-sm font-medium">
          ...
          <button
            onClick={() =>
              signIn('github', { callbackUrl: `${process.env.SERVER}` })
            }
            className="w-full flex items-center justify-center gap-x-3 py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100"
          >
            <svg
